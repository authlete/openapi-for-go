...
type TokenEndpointApi interface {
	...
	/*
	AuthTokenApi /api/{serviceId}/auth/token API
...
```
  ...
  signature by yourself.
	...
	*/
	...
	/*
	AuthTokenFailApi /api/{serviceId}/auth/token/fail API
...
```
	...
	*/
	...
	/*
	AuthTokenIssueApi /api/{serviceId}/auth/token/issue API
...
```
	...
	*/
	...
	/*
	IdtokenReissueApi /api/{serviceId}/idtoken/reissue API
