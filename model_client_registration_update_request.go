...
type _ClientRegistrationUpdateRequest ClientRegistrationUpdateRequest
...
func (o *ClientRegistrationUpdateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varClientRegistrationUpdateRequest := _ClientRegistrationUpdateRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varClientRegistrationUpdateRequest)

	if err != nil {
		return err
	}

	*o = ClientRegistrationUpdateRequest(varClientRegistrationUpdateRequest)
