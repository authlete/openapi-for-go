...
type GrantManagementEndpointAPI interface {
	...
	*/
	GrantMApi(ctx context.Context, serviceId string) ApiGrantMApiRequest
...
defined in "<a href="https://openid.net/specs/fapi-grant-management.html">Grant Management for OAuth 2.0</a>".
	...
	@return ApiGrantMApiRequest
*/
func (a *GrantManagementEndpointAPIService) GrantMApi(ctx context.Context, serviceId string) ApiGrantMApiRequest {
	return ApiGrantMApiRequest{
		ApiService: a,
		ctx:        ctx,
		serviceId:  serviceId,
...
func (a *GrantManagementEndpointAPIService) GrantMApiExecute(r ApiGrantMApiRequest) (*GMResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/{serviceId}/gm"
	...
	if r.gMRequest == nil {
		return localVarReturnValue, nil, reportError("gMRequest is required and must be specified")
	}
