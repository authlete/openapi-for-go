...
type _ClientFlagUpdateRequest ClientFlagUpdateRequest
...
func (o *ClientFlagUpdateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varClientFlagUpdateRequest := _ClientFlagUpdateRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varClientFlagUpdateRequest)

	if err != nil {
		return err
	}

	*o = ClientFlagUpdateRequest(varClientFlagUpdateRequest)
