...
type JWKSetEndpointAPI interface {
	...
	*/
	ServiceJwksGetApi(ctx context.Context, serviceId string) ApiServiceJwksGetApiRequest
...
if the service supports [OpenID Connect Discovery 1.0](https://openid.net/specs/openid-connect-discovery-1_0.html).
	...
	@return ApiServiceJwksGetApiRequest
*/
func (a *JWKSetEndpointAPIService) ServiceJwksGetApi(ctx context.Context, serviceId string) ApiServiceJwksGetApiRequest {
	return ApiServiceJwksGetApiRequest{
		ApiService: a,
		ctx:        ctx,
		serviceId:  serviceId,
...
func (a *JWKSetEndpointAPIService) ServiceJwksGetApiExecute(r ApiServiceJwksGetApiRequest) (*ServiceJwksGetResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/{serviceId}/service/jwks/get"
	...
	if r.includePrivateKeys != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "includePrivateKeys", r.includePrivateKeys, "", "")
	}
	if r.pretty != nil {
