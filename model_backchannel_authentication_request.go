...
type _BackchannelAuthenticationRequest BackchannelAuthenticationRequest
...
func (o *BackchannelAuthenticationRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBackchannelAuthenticationRequest := _BackchannelAuthenticationRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBackchannelAuthenticationRequest)

	if err != nil {
		return err
	}

	*o = BackchannelAuthenticationRequest(varBackchannelAuthenticationRequest)
