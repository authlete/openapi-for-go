...
type _VciMetadataRequest VciMetadataRequest
...
func (o *VciMetadataRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varVciMetadataRequest := _VciMetadataRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVciMetadataRequest)

	if err != nil {
		return err
	}

	*o = VciMetadataRequest(varVciMetadataRequest)
