...
not deleted and scopes of existing access tokens are not changed.
	...
	*/
	...
	//  @return Result
	ClientGrantedScopesDeleteApiExecute(r ApiClientGrantedScopesDeleteApiRequest) (*Result, *http.Response, error)
...
Example: `[ "profile", "email" ]`
	...
	*/
	...
	/*
	ClientSecretRefreshApi /api/client/secret/refresh/{clientIdentifier} API
...
If you want to specify a new value, use `/api/client/secret/update` API.
	...
	*/
	...
	/*
	ClientSecretUpdateApi /api/client/secret/update/{clientIdentifier} API
...
func (a *ClientManagementApiService) ClientCreateApiExecute(r ApiClientCreateApiRequest) (*Client, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/client/create"
...
func (a *ClientManagementApiService) ClientGetListApiExecute(r ApiClientGetListApiRequest) (*ClientGetListResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/client/get/list"
...
func (r ApiClientGrantedScopesDeleteApiRequest) Execute() (*Result, *http.Response, error) {
...
// Execute executes the request
//  @return Result
func (a *ClientManagementApiService) ClientGrantedScopesDeleteApiExecute(r ApiClientGrantedScopesDeleteApiRequest) (*Result, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
