...
type AuthorizationEndpointApi interface {
	...
	/*
	ApiServiceIdAuthAuthorizationTicketInfoGet /api/{serviceId}/auth/authorization/ticket/info API
	...
	*/
	...
	/*
	ApiServiceIdAuthAuthorizationTicketUpdatePost /api/{serviceId}/auth/authorization/ticket/update API
	...
	*/
	...
	/*
	AuthAuthorizationApi /api/{serviceId}/auth/authorization API
...
above in the description for the case of `action=NO_INTERACTION`.
	...
	*/
	...
	/*
	AuthAuthorizationFailApi /api/{serviceId}/auth/authorization/fail API
...
```
	...
	*/
	...
	/*
	AuthAuthorizationIssueApi /api/{serviceId}/auth/authorization/issue API
