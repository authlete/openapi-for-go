...
// checks if the VciBatchIssueResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VciBatchIssueResponse{}

// VciBatchIssueResponse struct for VciBatchIssueResponse
...
func (o VciBatchIssueResponse) MarshalJSON() ([]byte, error) {
...
func (o VciBatchIssueResponse) ToMap() (map[string]interface{}, error) {
...
type NullableVciBatchIssueResponse struct {
	value *VciBatchIssueResponse
	isSet bool
}

func (v NullableVciBatchIssueResponse) Get() *VciBatchIssueResponse {
	return v.value
}

func (v *NullableVciBatchIssueResponse) Set(val *VciBatchIssueResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVciBatchIssueResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVciBatchIssueResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVciBatchIssueResponse(val *VciBatchIssueResponse) *NullableVciBatchIssueResponse {
	return &NullableVciBatchIssueResponse{value: val, isSet: true}
}

func (v NullableVciBatchIssueResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVciBatchIssueResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
