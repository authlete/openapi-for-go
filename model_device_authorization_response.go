...
type DeviceAuthorizationResponse struct {
	...
	ClientAuthMethod *ClientAuthenticationMethod `json:"clientAuthMethod,omitempty"`
...
// SetClientAuthMethod gets a reference to the given ClientAuthenticationMethod and assigns it to the ClientAuthMethod field.
