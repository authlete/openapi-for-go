...
type UtilityEndpointsAPI interface {
...
type ApiInfoApiRequest struct {
	ctx        context.Context
	ApiService UtilityEndpointsAPI
}
...
get the server version and enabled features
	...
	@return ApiInfoApiRequest
*/
func (a *UtilityEndpointsAPIService) InfoApi(ctx context.Context) ApiInfoApiRequest {
	return ApiInfoApiRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return InfoResponse
func (a *UtilityEndpointsAPIService) InfoApiExecute(r ApiInfoApiRequest) (*InfoResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UtilityEndpointsAPIService.InfoApi")
	if err != nil {
...
Echo test endpoint. Will return all path parameters in the request
	...
	@return ApiMiscEchoApiRequest
*/
func (a *UtilityEndpointsAPIService) MiscEchoApi(ctx context.Context) ApiMiscEchoApiRequest {
	return ApiMiscEchoApiRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *UtilityEndpointsAPIService) MiscEchoApiExecute(r ApiMiscEchoApiRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodGet
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UtilityEndpointsAPIService.MiscEchoApi")
	if err != nil {
