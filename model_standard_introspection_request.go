...
type _StandardIntrospectionRequest StandardIntrospectionRequest
...
func (o *StandardIntrospectionRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varStandardIntrospectionRequest := _StandardIntrospectionRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varStandardIntrospectionRequest)

	if err != nil {
		return err
	}

	*o = StandardIntrospectionRequest(varStandardIntrospectionRequest)
