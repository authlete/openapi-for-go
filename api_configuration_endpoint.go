...
type ConfigurationEndpointApi interface {
	...
	/*
	ServiceConfigurationApi /api/{serviceId}/service/configuration API
...
in OpenID Connect Discovery 1.0.
 ...
 @return ApiServiceConfigurationApiRequest
*/
func (a *ConfigurationEndpointApiService) ServiceConfigurationApi(ctx context.Context, serviceId string) ApiServiceConfigurationApiRequest {
	return ApiServiceConfigurationApiRequest{
		ApiService: a,
		ctx: ctx,
		serviceId: serviceId,
