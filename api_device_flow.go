...
type DeviceFlowApi interface {
	...
	/*
	DeviceAuthorizationApi /api/{serviceId}/device/authorization API
...
and return to the client application.
	...
	*/
	...
	/*
	DeviceCompleteApi /api/{serviceId}/device/complete API
...
using.
	...
	*/
	...
	/*
	DeviceVerificationApi /api/{serviceId}/device/verification API
