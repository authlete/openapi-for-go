...
type CIBAApi interface {
	...
	/*
	BackchannelAuthenticationApi /api/{serviceId}/backchannel/authentication API
...
not have to be changed to support CIBA.
	...
	*/
	...
	/*
	BackchannelAuthenticationCompleteApi /api/{serviceId}/backchannel/authentication/complete API
...
```
	...
	*/
	...
	/*
	BackchannelAuthenticationFailApi /api/{serviceId}/backchannel/authentication/fail API
...
server implementation should return a "403 Forbidden" response to the client application.
	...
	*/
	...
	/*
	BackchannelAuthenticationIssueApi /api/{serviceId}/backchannel/authentication/issue API
