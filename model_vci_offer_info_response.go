...
// checks if the VciOfferInfoResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VciOfferInfoResponse{}

// VciOfferInfoResponse struct for VciOfferInfoResponse
...
func (o VciOfferInfoResponse) MarshalJSON() ([]byte, error) {
...
func (o VciOfferInfoResponse) ToMap() (map[string]interface{}, error) {
...
type NullableVciOfferInfoResponse struct {
	value *VciOfferInfoResponse
	isSet bool
}

func (v NullableVciOfferInfoResponse) Get() *VciOfferInfoResponse {
	return v.value
}

func (v *NullableVciOfferInfoResponse) Set(val *VciOfferInfoResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVciOfferInfoResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVciOfferInfoResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVciOfferInfoResponse(val *VciOfferInfoResponse) *NullableVciOfferInfoResponse {
	return &NullableVciOfferInfoResponse{value: val, isSet: true}
}

func (v NullableVciOfferInfoResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVciOfferInfoResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
