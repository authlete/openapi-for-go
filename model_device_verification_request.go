...
type _DeviceVerificationRequest DeviceVerificationRequest
...
func (o *DeviceVerificationRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varDeviceVerificationRequest := _DeviceVerificationRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeviceVerificationRequest)

	if err != nil {
		return err
	}

	*o = DeviceVerificationRequest(varDeviceVerificationRequest)
