...
type _BackchannelAuthenticationIssueRequest BackchannelAuthenticationIssueRequest
...
func (o *BackchannelAuthenticationIssueRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBackchannelAuthenticationIssueRequest := _BackchannelAuthenticationIssueRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBackchannelAuthenticationIssueRequest)

	if err != nil {
		return err
	}

	*o = BackchannelAuthenticationIssueRequest(varBackchannelAuthenticationIssueRequest)
