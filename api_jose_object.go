...
type JoseObjectAPI interface {
	...
	*/
	JoseVerifyApi(ctx context.Context, serviceId string) ApiJoseVerifyApiRequest
...
This API verifies a JOSE object.
	...
	@return ApiJoseVerifyApiRequest
*/
func (a *JoseObjectAPIService) JoseVerifyApi(ctx context.Context, serviceId string) ApiJoseVerifyApiRequest {
	return ApiJoseVerifyApiRequest{
		ApiService: a,
		ctx:        ctx,
		serviceId:  serviceId,
...
func (a *JoseObjectAPIService) JoseVerifyApiExecute(r ApiJoseVerifyApiRequest) (*JoseVerifyResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/{serviceId}/jose/verify"
