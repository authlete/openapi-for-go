...
type _ClientRegistrationDeleteRequest ClientRegistrationDeleteRequest
...
func (o *ClientRegistrationDeleteRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varClientRegistrationDeleteRequest := _ClientRegistrationDeleteRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varClientRegistrationDeleteRequest)

	if err != nil {
		return err
	}

	*o = ClientRegistrationDeleteRequest(varClientRegistrationDeleteRequest)
