...
// List of token_type
const (
	TOKENTYPE_URN_IETF_PARAMS_OAUTH_TOKEN_TYPE_JWT           TokenType = "urn:ietf:params:oauth:token-type:jwt"
	TOKENTYPE_URN_IETF_PARAMS_OAUTH_TOKEN_TYPE_ACCESS_TOKEN  TokenType = "urn:ietf:params:oauth:token-type:access_token"
	TOKENTYPE_URN_IETF_PARAMS_OAUTH_TOKEN_TYPE_REFRESH_TOKEN TokenType = "urn:ietf:params:oauth:token-type:refresh_token"
	TOKENTYPE_URN_IETF_PARAMS_OAUTH_TOKEN_TYPE_ID_TOKEN      TokenType = "urn:ietf:params:oauth:token-type:id_token"
	TOKENTYPE_URN_IETF_PARAMS_OAUTH_TOKEN_TYPE_SAML1         TokenType = "urn:ietf:params:oauth:token-type:saml1"
	TOKENTYPE_URN_IETF_PARAMS_OAUTH_TOKEN_TYPE_SAML2         TokenType = "urn:ietf:params:oauth:token-type:saml2"
