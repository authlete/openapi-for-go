...
// APIClient manages communication with the Authlete API API v2.3.12
...
type APIClient struct {
	...
	IDTokenEndpointApi IDTokenEndpointApi
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.IDTokenEndpointApi = (*IDTokenEndpointApiService)(&c.common)
